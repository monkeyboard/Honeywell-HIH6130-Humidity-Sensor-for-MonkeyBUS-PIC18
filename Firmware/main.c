...
/******************************************************************************
 * Function:        void PrintHihData (unsigned short humidity, 
 *						unsigned short temperature)
 *
 * PreCondition:    None
 *
 * Input:           Humidity and temperature reading
 *
 * Output:          None
 *
 * Side Effects:    None
 *
 * Overview:        This routine prints reading to USB serial emulator
 *					H<Humidity %>T<Temperature C>
 *
 * Note:            
 *
 *****************************************************************************/
void PrintHihData (unsigned short humidity, unsigned short temperature)
{
	NextUSBOut = 0;
	itoa (humidity, _buff);
...
/******************************************************************************
 * Function:        char GetHihReading (unsigned short *pHumd, 
 * 					short *pTemp)
 *
 * PreCondition:    None
 *
 * Input:           Humidity and temperature variable
 *
 * Output:          None
 *
 * Side Effects:    None
 *
 * Overview:        This routine gets humidity and temperature reading from
 *					HIH6130
 *
 * Note:            
 *
...
char GetHihReading (unsigned short *pHumd, short *pTemp)
{
	...
	do
	{
		...
		I2CGetBytes (((HIH6310 << 1) | 0x01), 4, &_buff);
		++attempts;
	}
...
{   
    ...
    while(1)
    {
		...
		PrintHihData (humidity, temperature);
...
/******************************************************************************
 * Function:        unsigned char getcUSART (void)
 *
 * PreCondition:    None
 *
 * Input:           None
 ...
 * Side Effects:    None
 *
 * Overview:        Get a character from UART
 *
 * Note:            
 *
 *****************************************************************************/
